...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '司总啊', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '培跑跨境企业，实现业绩倍增🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.zsmq.tech/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '司总, TikTok', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个跨境从业者, Hi，我是一个跨境从业者,Hi，我是一个跨境从业者,欢迎来到我的博客🎉',
